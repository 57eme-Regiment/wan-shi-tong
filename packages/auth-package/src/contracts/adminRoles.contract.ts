...
export const adminRoleContract = c.router(
  {
    getRoles: c.query({
      ...
      description:
        ...
        'Requiert la permission `WAN_ROLE_READ`.',
      metadata: {
        tags: ['Admin - Rôles'],
        permission: PERMISSIONS.WAN_ROLE_READ,
      },
    }),
    createRole: c.mutation({
      ...
      description:
        ...
        'Requiert la permission `WAN_ROLE_CREATE`.',
      metadata: {
        tags: ['Admin - Rôles'],
        permission: PERMISSIONS.WAN_ROLE_CREATE,
      },
    }),
    updateRole: c.mutation({
      ...
      description:
        ...
        'Requiert la permission `WAN_ROLE_MANAGE`.',
      metadata: {
        tags: ['Admin - Rôles'],
        permission: PERMISSIONS.WAN_ROLE_MANAGE,
      },
    }),
    deleteRole: c.mutation({
      ...
      description:
        ...
        'Requiert la permission `WAN_ROLE_DELETE`.',
      metadata: {
        tags: ['Admin - Rôles'],
        permission: PERMISSIONS.WAN_ROLE_DELETE,
      },
    }),
    ...
    addRolePermission: c.mutation({
      ...
      description:
        ...
        'Retourne 409 si la permission est déjà assignée. Requiert `WAN_ROLE_MANAGE`.',
      metadata: {
        tags: ['Admin - Rôles'],
        permission: PERMISSIONS.WAN_ROLE_MANAGE,
      },
    ...
    removeRolePermission: c.mutation({
      ...
      description:
        ...
        'Retourne 404 si le lien est introuvable. Requiert `WAN_ROLE_CREATE`.',
      metadata: {
        tags: ['Admin - Rôles'],
        permission: PERMISSIONS.WAN_ROLE_CREATE,
      },
